...
public class PlayerUnlockBlockEvent extends LSPlayerEvent implements Cancellable {
	 ...
	 */
	public PlayerUnlockBlockEvent(LockSecurityPlayer player, LockedBlock block, boolean byCommand) {
		super(player);
		this.block = block;
	 ...
	 * @param block the unlocked block
	 */
	public PlayerUnlockBlockEvent(LockSecurityPlayer player, LockedBlock block) {
