package wtf.choco.locksecurity.utils;
...
public class ItemBuilder {
	...
	/**
	 * Construct a new ItemBuilder based on an existing ItemStack instance
	 * 
	 * @param item the ItemStack instance on which to base this builder
	 */
