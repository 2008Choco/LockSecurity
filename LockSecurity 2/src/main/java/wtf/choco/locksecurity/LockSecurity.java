...
import wtf.choco.locksecurity.utils.ItemBuilder;
...
public class LockSecurity extends JavaPlugin {
	...
	public void onEnable() {
		...
		Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(this, "unsmithed_key1"), unsmithedKey).shape("B  ", " I ", "  P").setIngredient('B', Material.IRON_FENCE).setIngredient('I', Material.IRON_INGOT).setIngredient('P', Material.WOOD));
		Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(this, "unsmithed_key2"), unsmithedKey).shape(" B ", " I ", " P ").setIngredient('B', Material.IRON_FENCE).setIngredient('I', Material.IRON_INGOT).setIngredient('P', Material.WOOD));
		Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(this, "unsmithed_key3"), unsmithedKey).shape("  B", " I ", "P  ").setIngredient('B', Material.IRON_FENCE).setIngredient('I', Material.IRON_INGOT).setIngredient('P', Material.WOOD));
		Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(this, "unsmithed_key4"), unsmithedKey).shape("   ", "BIP", "   ").setIngredient('B', Material.IRON_FENCE).setIngredient('I', Material.IRON_INGOT).setIngredient('P', Material.WOOD));
		Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(this, "unsmithed_key5"), unsmithedKey).shape("   ", "PIB", "   ").setIngredient('B', Material.IRON_FENCE).setIngredient('I', Material.IRON_INGOT).setIngredient('P', Material.WOOD));
		Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(this, "unsmithed_key6"), unsmithedKey).shape("  P", " I ", "B  ").setIngredient('B', Material.IRON_FENCE).setIngredient('I', Material.IRON_INGOT).setIngredient('P', Material.WOOD));
		Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(this, "unsmithed_key7"), unsmithedKey).shape(" P ", " I ", " B ").setIngredient('B', Material.IRON_FENCE).setIngredient('I', Material.IRON_INGOT).setIngredient('P', Material.WOOD));
		Bukkit.addRecipe(new ShapedRecipe(new NamespacedKey(this, "unsmithed_key8"), unsmithedKey).shape("P  ", " I ", "  B").setIngredient('B', Material.IRON_FENCE).setIngredient('I', Material.IRON_INGOT).setIngredient('P', Material.WOOD));
	...
	public void onDisable() {
		...
		if (playerRegistry != null) {
			...
			this.playerRegistry.getPlayers().forEach(LockSecurityPlayer::clearLocalData);
	...
	/**
	 * Get an instance of the LockSecurityPlugin class
	 * 
