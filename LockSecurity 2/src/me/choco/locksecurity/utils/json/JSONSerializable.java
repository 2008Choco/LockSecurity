...
/** Any object that should be serialized as a JSON object should 
 * implement this class to contain {@link #write(JSONObject)} and {@link #read(JSONObject)} methods for
 * simplicity and ease.
