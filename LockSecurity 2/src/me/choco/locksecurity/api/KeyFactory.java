...
public class KeyFactory {
	...
	/** Get a singular unsmithed key. 
	 * A method to simplify the KeyBuilder aspect of {@link KeyType#UNSMITHED}
	...
	/** Get a certain amount of unsmithed keys. 
	 * A method to simplify the KeyBuilder aspect of {@link KeyType#UNSMITHED}
	 * @param amount - The amount of unsmithed keys to create
	 * @return (amount) unsmithed keys
	 */
	 ...
	 * @return (amount) keys with merged Key ID values. null if neither are smithed keys
	 */
